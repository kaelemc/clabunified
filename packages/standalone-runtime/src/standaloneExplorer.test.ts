...
test("standalone explorer no longer renders the Help & Feedback section", async () => {
  ...
  assert.equal(
    helpSection,
    undefined,
    "Help & Feedback moved to the sidebar rail (?) modal and should not appear as an explorer section",
  );
});
